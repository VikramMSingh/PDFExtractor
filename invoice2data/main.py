...
## Importing module required for running the program 
import argparse
import shutil
import os
...
## Importing extracters from input - to add additional extracters will need to do it in input directory 
...
## Template reader - needs improvement
...
## To decide what text extracter are we using 
input_mapping = {
    "pdftotext": pdftotext,
    "pdfminer": pdfminer_wrapper,
}

# Do we want to convert it to json or csv or xml
